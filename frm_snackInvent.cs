...
namespace snackShack
{
    public partial class frm_snackInvent : Form
    {
        ...
        private void frm_snackInvent_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show("Error during file write", ex.ToString(), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        private void frm_snackInvent_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error during file read", ex.ToString(), MessageBoxButtons.OK, MessageBoxIcon.Error);
